...
dataset3 = Dataset("s3://dataset3/output_3.txt")

@dag(
    dag_id="update_dataset_dag_3",
...
def update_dataset_dag_3():
    ...
    def load_data(data: str):
        ...
        print(f"Dataset {dataset3.uri} updated.")
