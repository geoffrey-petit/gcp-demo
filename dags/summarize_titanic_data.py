...
@dag(
    ...
    schedule=None,
    start_date=pendulum.from_format("2024-09-11", "YYYY-MM-DD"),
    catchup=False,
    owner_links={
        "Open in Cloud IDE": "https://cloud.astronomer.io/clf8k1ny782776750cybqqbizf/cloud-ide/cllldngjn002701h3gcpmimpb/cllldngqu006301fgp4s0dbv6",
    },
)
def summarize_titanic_data():
    load = load_func()
    ...
    local_filesystem_to_s3_operator_1 = LocalFilesystemToS3Operator(
        task_id="local_filesystem_to_s3_operator_1",
    )
    ...
    local_filesystem_to_s3_operator_1 << aggregate_python

dag_obj = summarize_titanic_data()
